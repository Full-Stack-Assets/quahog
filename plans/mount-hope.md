...
- [~] **Drivable highways detailing (2026-06-27)** — motorway/trunk (+links) now read as highways: **steel guardrails** flank the carriageway and **green MUTCD guide-sign gantries** span long mainline runs; highways no longer get city sidewalks. All visual (driving still uses the ground plane). Still want: on/off ramps as distinct surfaces, lane markings, and fast travel bringing your car.
- [~] **Fall River heroes (2026-06-27)** — **Braga (“Verde”) Bridge** built as a green through-truss framing the real 823 m I-195 deck over the Taunton beside Battleship Cove (chords + verticals + web diagonals + portal bracing; asphalt stays drivable). **Hero beacons**: 15 curated South Coast landmarks (Whaling Museum, Fort Taber, Clark’s Point Light, Battleship Cove, FR City Hall, the cathedrals, Green Monstah mural, Dartmouth/Westport/UMassD) carry an emissive dusk beacon + billboard name. Still want: USS Massachusetts hull model, Lizzie Borden House, granite-mill district tint.
