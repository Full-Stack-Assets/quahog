...
3. [ ] Camera collision — chase cam doesn't clip through buildings.
4. [ ] Brake vs reverse feel + handbrake.
5. [ ] Flip/stuck recovery (right the car if overturned or wedged).
6. [ ] Horn (button + SFX).
7. [ ] Headlights on at night.
8. [ ] Speedometer correctness (km/h) + needle.
