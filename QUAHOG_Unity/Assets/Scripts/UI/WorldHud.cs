...
namespace Quahog.SouthCoast
{
    ...
    public class WorldHud : MonoBehaviour
    {
        ...
        private void BuildUi()
        {
            ...
            help.text = "[W] weather   [↑] +wanted   [↓] clear   [T] +1h";
        }
        ...
        {
            if (Input.GetKeyDown(KeyCode.W) && WeatherController.Instance != null)
            {
            ...
            if (Input.GetKeyDown(KeyCode.UpArrow) && HeatManager.Instance != null)
                HeatManager.Instance.AddWantedLevel(1);

            if (Input.GetKeyDown(KeyCode.DownArrow) && HeatManager.Instance != null)
                HeatManager.Instance.ClearHeat();

            if (Input.GetKeyDown(KeyCode.T) && TimeOfDayClock.Instance != null)
                TimeOfDayClock.Instance.AdvanceHours(1);
        }
